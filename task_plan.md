...
| 2 | Atualização da Sidebar (Reatividade) | `frontend/.../core/services/app-sync.service.ts` (novo), `frontend/.../core/layout/sidebar.component.ts` e demais forms que criam entidades | ⏳ Pendente |
