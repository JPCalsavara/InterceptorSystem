...
namespace InterceptorSystem.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260309194444_Initial_Refactoring_Phase2")]
    partial class Initial_Refactoring_Phase2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InterceptorSystem.Domain.BoundedContexts.Operacoes.Aggregates.Posto", b =>
                {
                    ...
                    b.HasOne("InterceptorSystem.Domain.BoundedContexts.Operacoes.Aggregates.Contrato", null)
                        .WithMany("Postos")
                        .HasForeignKey("ContratoId");
