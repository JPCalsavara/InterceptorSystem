...
- **Core Directories**:
  ...
  - `features/`: Business domain modules/components (e.g., `condominios`, `funcionarios`, `alocacoes`).
...
- **`condominios.service.ts`** (`src/app/services`): Examples of standard CRUD API consumption and Observable data flows.
