...
public record CondominioDtoOutput(Guid Id, string Nome, string Cnpj, bool Ativo)
{
    ...
    public static CondominioDtoOutput FromEntity(Domain.Modulos.Administrativo.Entidades.Condominio entity)
    {
        ...
        return new CondominioDtoOutput(entity.Id, entity.Nome, entity.Cnpj, entity.Ativo);
    }
}